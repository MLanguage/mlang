...
const struct m_value m_undefined =
    (struct m_value){.value = 0, .undefined = true};
...
m_value m_max(m_value x, m_value y) {
  return (struct m_value){.value = fmax(x.value, y.value), .undefined = false};
}

m_value m_min(m_value x, m_value y) {
  return (struct m_value){.value = fmin(x.value, y.value), .undefined = false};
}
...
m_value m_floor(m_value x) {
  ...
  return (struct m_value){.value = floor(x.value + 0.000001),
                          .undefined = false};
}
