...
(** While [type:Mir.program] contains the AST of all rules, [type:full_program] also encapsulates
    the dependency order of the rules. *)

val reset_all_outputs : Mir.program -> Mir.program
(** This function defines the [var_io] property of [var_data] to [Regular] for all variables that
    don't have [Input] as their [var_io]. *)
