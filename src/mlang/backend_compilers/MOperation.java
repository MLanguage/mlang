...
class MOperation {
  ...
  private static OptionalDouble m_neg(OptionalDouble value) {
    if (value.isEmpty()) {
      return value;
    }
  ...
  private static OptionalDouble m_round(OptionalDouble value) {
    ...
    return OptiopnalDouble.of(Math.round(valueToRound));
  }
  ...
  private static OptionalDouble m_floor(OptionalDouble value) {
    ...
    return OptiopnalDouble.of(Math.floor(valueToFloor));
  }

  private static OptionalDouble m_max(OptionalDouble value) {
    if (!value.isPresent()) {
      return value;
    }
    double valueToFloor = value.getAsDouble() + 0.000001;
  ...
  private static OptionalDouble m_min(OptionalDouble value) {
    if (!value.isPresent()) {
      return value;
    }
    double valueToFloor = value.getAsDouble() + 0.000001;
