...
type expression =
  ...
  *)
  | Conditional of
      expression Pos.marked * expression Pos.marked * expression Pos.marked option
...
type verification_condition = {
  ...
  verif_cond_errors: error_name Pos.marked list (** A verification condition can trigger multiple errors *)
}
