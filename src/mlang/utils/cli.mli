...
(** [add_prefix_to_each_line msg prefix] will print msg but each line with line number [i] starts
    with the string [prefix i]*)

(**{2 Printers}*)

val format_with_style : ANSITerminal.style list -> ('a, unit, string) format -> 'a

(** All the printers below print their argument after the correct marker *)

val var_info_print : ('a, Format.formatter, unit, unit) format4 -> 'a

val debug_print : ?endline:string -> ('a, Format.formatter, unit, unit) format4 -> 'a
