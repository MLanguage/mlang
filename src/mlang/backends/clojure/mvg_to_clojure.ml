...
let rec generate_clj_expr (e: expression Pos.marked) (scc: unit VariableMap.t) : string =
  ...
  | Conditional (((LocalVar _, _) as e1), e2, e3) ->
    ...
    Format.asprintf "if (get (%s) \"is_undef\") (undef nil) (if (get (%s) \"b\") (%s) (%s))"
      s1 s1 s2 s3
  | Conditional (e1, e2, e3) ->
    ...
    in generate_clj_expr new_e scc
...
let generate_var_def
  ...
  | Not_found ->
    ...
    Format.fprintf oc
      "; Verification condition %a\n(defn %s [values] (\n    let [%s (%s)] (\n    if (and (not (get %s \"is_undef\")) (get %s \"b\")) (throw (AssertionError. \"Error triggered\\n%s\")) values)\n))\n\n"
...
(defn add_mvalue [v1 v2] (if (and (get v1 \"is_undef\") (get v2 \"is_undef\")) (undef nil) (mk_value (+ (get v1 \"v\") (get v2 \"v\")))))

(defn sub_mvalue [v1 v2] (if (and (get v1 \"is_undef\") (get v2 \"is_undef\")) (undef nil) (mk_value (- (get v1 \"v\") (get v2 \"v\")))))

(defn mul_mvalue [v1 v2] (if (or (get v1 \"is_undef\") (get v2 \"is_undef\")) (undef nil) (mk_value (* (get v1 \"v\") (get v2 \"v\")))))

(defn div_mvalue [v1 v2] (if (or (get v1 \"is_undef\") (get v2 \"is_undef\")) (undef nil) (if (= (get v2 \"v\") 0.0) (undef nil) (mk_value (/ (get v1 \"v\") (get v2 \"v\"))))))

(defn minus_mvalue [v] (if (get v \"is_undef\") (undef nil) (mk_value (- (v \"v\")))))

(defn round_mvalue [v] (if (get v \"is_undef\") (undef nil) (mk_value (Math/round (get v \"v\")))))

(defn floor_mvalue [v] (if (get v \"is_undef\") (undef nil) (mk_value (Math/floor (get v \"v\")))))

(defn not_mvalue [v] (if (get v \"is_undef\") (undef nil) (mk_value (not (get v \"b\")))))

(defn and_mvalue [v1 v2] (if (or (get v1 \"is_undef\") (get v2 \"is_undef\")) (undef nil) (mk_bool (and (get v1 \"b\") (get v2 \"b\")))))

(defn or_mvalue [v1 v2] (if (or (get v1 \"is_undef\") (get v2 \"is_undef\")) (undef nil) (mk_bool (or (get v1 \"b\") (get v2 \"b\")))))

(defn eq_mvalue [v1 v2] (if (or (get v1 \"is_undef\") (get v2 \"is_undef\")) (undef nil) (mk_bool (= (get v1 \"v\") (get v2 \"v\")))))

(defn neq_mvalue [v1 v2] (if (or (get v1 \"is_undef\") (get v2 \"is_undef\")) (undef nil) (mk_bool (not (= (get v1 \"v\") (get v2 \"v\"))))))

(defn lt_mvalue [v1 v2] (if (or (get v1 \"is_undef\") (get v2 \"is_undef\")) (undef nil) (mk_bool (< (get v1 \"v\") (get v2 \"v\")))))

(defn lte_mvalue [v1 v2] (if (or (get v1 \"is_undef\") (get v2 \"is_undef\")) (undef nil) (mk_bool (<= (get v1 \"v\") (get v2 \"v\")))))

(defn gt_mvalue [v1 v2] (if (or (get v1 \"is_undef\") (get v2 \"is_undef\")) (undef nil) (mk_bool (> (get v1 \"v\") (get v2 \"v\")))))

(defn gte_mvalue [v1 v2] (if (or (get v1 \"is_undef\") (get v2 \"is_undef\")) (undef nil) (mk_bool (>= (get v1 \"v\") (get v2 \"v\")))))
